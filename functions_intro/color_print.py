...
print(RED, "This will be in red")  # How to print in red.
print("and so is this")  # Colors stay in effect until canceled.
...
colour_print("Hello, Yellow bold underlined", YELLOW, BOLD, UNDERLINE)
